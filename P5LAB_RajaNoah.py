...
def calculations():
    ...
    while howmuchcash < randommoney:
        print("You have not inserted enough to cover the cost")
        print(f"You still owe {randommoney - howmuchcash:.2f}")
        additional_cash = float(input("How much will you add to your balance? "))
        howmuchcash += additional_cash
        print(f"New balance: ${howmuchcash}")
